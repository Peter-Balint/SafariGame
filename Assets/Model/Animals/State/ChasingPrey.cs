...
namespace Safari.Model.Animals.State
{
    public class ChasingPrey : State
    {
        ...
        public ChasingPrey(Animal owner, double hydrationPercent, double saturationPercent, double breedingCooldown, FollowPreyMovementCommand command, IPrey prey) : base(owner, hydrationPercent, saturationPercent, breedingCooldown)
        {
        ...
        private void OnPreyEscaped(object sender, EventArgs e)
        {
            ...
            prey.OnEscaped();
            TransitionTo(new FailedHunting(this.owner, hydrationPercent, saturationPercent, breedingCooldown));
        }
        ...
        private void OnChasingFinished(object sender, EventArgs e)
        {
            ...
            TransitionTo(new PredatorEating(owner, hydrationPercent, saturationPercent, breedingCooldown));
        }
